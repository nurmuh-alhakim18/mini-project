...
-- AddForeignKey
ALTER TABLE `Event` ADD CONSTRAINT `Event_oraganizerId_fkey` FOREIGN KEY (`oraganizerId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
